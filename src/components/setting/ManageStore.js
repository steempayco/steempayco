...
class AddStore extends Component {
    ...
    handleSave = () => {
        ...
        if (!this.props.storeData) this.setState({ storeData: {} });
    ...
    render() {
        ...
        return (
            ...
            >
                <Header
                    icon="paste"
                    content={editMode ? "Modify a store" : "Add a store"}
                />
                <Modal.Content>
                    <Form>
                        <Form.Input
                            ...
                            defaultValue={this.state.storeData.name}
                        ...
                        <Form.Input
                            ...
                            defaultValue={this.state.storeData.description}
                            onChange={this.handleChange}
                        />
                        <Form.Input
                            fluid
                            ...
                            defaultValue={this.state.storeData.address}
                            onChange={this.handleChange}
                        />
                        <Form.Select
                            fluid
                            ...
                            options={[...params.receivers, ...params.exchanges]}
                            placeholder="Choose the receiving account"
                            defaultValue={this.state.storeData.linkedAccount}
                            onChange={this.handleChange}
                        />
                        <Form.Select
                            fluid
                            ...
                            defaultValue={this.state.storeData.currency}
                            onChange={this.handleChange}
                            direction="left"
                        />
                    </Form>
